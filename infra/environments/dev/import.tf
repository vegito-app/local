...
import {
  id = "${data.google_project.project.id}/locations/${var.region}/instances/${data.google_project.project.project_id}-dev-rtdb-default"
...
import {
  id = "${data.google_project.project.id}/servicgithub-actions-main@moov-dev-439608.iam.gserviceaccount.comeAccounts/production-application-backend@${data.google_project.project.project_id}.iam.gserviceaccount.com"
  to = module.application.google_service_account.application_backend_cloud_run_sa
}
import {
  id = "${data.google_project.project.id}/secretgithub-actions-main@moov-dev-439608.iam.gserviceaccount.coms/googlemaps-web-api-key"
...
import {
  id = "${data.google_project.project.id}/androidApps/1:${data.google_project.project.number}:android:da323c7e225ac6703f87b9"
  to = module.application.google_firebase_android_app.android_app
}
import {
  id = "${data.google_project.project.id}/iosApps/1:${data.google_project.project.number}:ios:583dd148142eb1953f87b9"
...
# import {
#   id = "projects/${data.google_project.project.number}/secrets/googlemaps-web-api-key/versions/1"
...
import {
  ...
  id = "${data.google_project.project.project_id} ${data.google_project.project.id}/webApps/1:${data.google_project.project.number}:web:b94790a22e3b60a13f87b9"
}
import {
