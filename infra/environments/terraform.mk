...
# @$(TERRAFORM) import google_storage_bucket.bucket_tf_state_eu utrade-$(REGION)-tf-state
...
# @$(TERRAFORM) import module.gcloud.google_secret_manager_secret.web_google_maps_api_key projects/378762893981/secrets/$(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-googlemaps-api-key
...
# @$(TERRAFORM) import module.gcloud.google_cloud_run_service.application_backend locations/$(REGION)/namespaces/$(GOOGLE_CLOUD_PROJECT_ID)/services/prod-$(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-application-backend
# $(TERRAFORM) import module.gcloud.google_cloudfunctions_function.auth_before_sign_in $(GOOGLE_CLOUD_PROJECT_ID)/$(REGION)/$(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-identity-platform-before-signin
...
# $(TERRAFORM) import module.gcloud.google_storage_bucket.bucket_gcf_source prod-$(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-gcf-source
# $(TERRAFORM) import module.gcloud.google_storage_bucket.bucket_tf_state_eu utrade-$(REGION)-tf-state
# $(TERRAFORM) import module.gcloud.module.cdn.google_compute_global_forwarding_rule.public_cdn $(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-public-cdn-forwarding-rule
# $(TERRAFORM) import module.gcloud.module.cdn.google_compute_target_http_proxy.public_cdn projects/$(GOOGLE_CLOUD_PROJECT_ID)/global/targetHttpProxies/$(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-public-cdn-http-proxy
# $(TERRAFORM) import module.gcloud.module.cdn.google_compute_url_map.url_map projects/$(GOOGLE_CLOUD_PROJECT_ID)/global/urlMaps/$(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-public-cdn-url-map
# $(TERRAFORM) import module.gcloud.module.cdn.google_storage_bucket_iam_binding.web_public_image "b/$(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-public-images-web roles/storage.objectViewer"
# $(TERRAFORM) import module.gcloud.module.cdn.google_storage_bucket.public_images  $(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-public-images-web
# $(TERRAFORM) import module.gcloud.google_cloudfunctions_function_iam_member.auth_before_sign_in "projects/$(GOOGLE_CLOUD_PROJECT_ID)/locations/$(REGION)/functions/$(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-identity-platform-before-signin roles/cloudfunctions.invoker allUsers"
# $(TERRAFORM) import module.gcloud.google_cloudfunctions_function_iam_member.auth_before_create "projects/$(GOOGLE_CLOUD_PROJECT_ID)/locations/$(REGION)/functions/$(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-identity-platform-before-create roles/cloudfunctions.invoker allUsers"
# $(TERRAFORM) import module.gcloud.google_cloud_run_service_iam_member.allow_unauthenticated "projects/$(GOOGLE_CLOUD_PROJECT_ID)/locations/$(REGION)/services/prod-$(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-application-backend roles/run.invoker allUsers"
# $(TERRAFORM) import module.gcloud.google_cloudfunctions_function.auth_before_create $(GOOGLE_CLOUD_PROJECT_ID)/$(REGION)/$(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-identity-platform-before-create
# $(TERRAFORM) import module.gcloud.module.cdn.google_compute_backend_bucket.public_cdn projects/$(GOOGLE_CLOUD_PROJECT_ID)/global/backendBuckets/$(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-public-cdn
...
# $(TERRAFORM) import module.gcloud.google_secret_manager_secret_version.web_google_maps_api_key_version projects/378762893981/secrets/$(GOOGLE_CLOUD_PROJECT_ID)-$(REGION)-googlemaps-api-key/versions/2
...
$(TF_STATE_ITEMS:%=%-rm): $(GOOGLE_CLOUD_APPLICATION_CREDENTIALS)
...
terraform-reconfigure: $(GOOGLE_CLOUD_APPLICATION_CREDENTIALS)
...
terraform-output-json: $(GOOGLE_CLOUD_APPLICATION_CREDENTIALS)
