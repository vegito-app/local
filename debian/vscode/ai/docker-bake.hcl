variable "VEGITO_DOCKER_DEBIAN_VSCODE_AI_DOCKER_DESKTOP_X_VERSION" {
  default = "${VEGITO_DOCKER_PUBLIC_IMAGES_BASE_NAME}:debian-vscode-ai-docker-desktop-x-${VERSION}"
}

variable "VEGITO_DOCKER_DEBIAN_VSCODE_AI_DOCKER_DESKTOP_X_IMAGE_REGISTRY_CACHE" {
  default = "${VEGITO_CACHE_IMAGES_BASE}/vegito-debian-vscode-ai-docker-desktop-x"
}
...
variable "VEGITO_DOCKER_DEBIAN_VSCODE_AI_DOCKER_DESKTOP_X_IMAGE_DOCKER_BUILDX_LOCAL_CACHE_VERSION" {
  default = "${VEGITO_DOCKER_BUILDX_LOCAL_CACHE_DIR}/debian-vscode-ai-docker-desktop-x-version"
}

variable "VEGITO_DOCKER_DEBIAN_VSCODE_AI_DOCKER_DESKTOP_X_IMAGE_DOCKER_BUILDX_LOCAL_CACHE_LATEST" {
  default = "${VEGITO_DOCKER_BUILDX_LOCAL_CACHE_DIR}/debian-vscode-ai-docker-desktop-x-latest"
}

variable "VEGITO_DOCKER_DEBIAN_VSCODE_AI_DOCKER_DESKTOP_X_IMAGE_DOCKER_BUILDX_CACHE_WRITE_VERSION" {
  description = "local write cache for vegito-debian-vscode-ai-docker-desktop-x version image build"
...
variable "VEGITO_DOCKER_DEBIAN_VSCODE_AI_DOCKER_DESKTOP_X_IMAGE_DOCKER_BUILDX_CACHE_WRITE_LATEST" {
  description = "local write cache for vegito-debian-vscode-ai-docker-desktop-x latest image build"
...
variable "VEGITO_DOCKER_DEBIAN_VSCODE_AI_DOCKER_DESKTOP_X_IMAGE_DOCKER_BUILDX_LOCAL_CACHE_READ_VERSION" {
  description = "local read cache for vegito-debian-vscode-ai-docker-desktop-x version image build (cannot be used before first write)"
...
variable "VEGITO_DOCKER_DEBIAN_VSCODE_AI_DOCKER_DESKTOP_X_IMAGE_DOCKER_BUILDX_LOCAL_CACHE_READ_LATEST" {
  description = "local read cache for vegito-debian-vscode-ai-docker-desktop-x latest image build (cannot be used before first write)"
...
variable "VEGITO_DOCKER_DEBIAN_VSCODE_AI_DOCKER_DESKTOP_X_IMAGE_LATEST" {
  default = "${VEGITO_DOCKER_PUBLIC_IMAGES_BASE_NAME}:debian-vscode-ai-docker-desktop-x-latest"
}
...
group "vegito-debian-vscode-ai-docker-desktop-x-ci" {
  description = "Build and push Debian VSCode images"
  targets = [
    "vegito-debian-vscode-ai-docker-desktop-x-version-ci",
    "vegito-debian-vscode-ai-docker-desktop-x-latest-ci",
  ]
}

target "vegito-debian-vscode-ai-docker-desktop-x-version-ci" {
...
target "vegito-debian-vscode-ai-docker-desktop-x-latest-ci" {
  context = VEGITO_DOCKER_DEBIAN_VSCODE_DIR
  contexts = {
...
target "vegito-debian-vscode-ai-docker-desktop-x" {
