  ...
  restrictions {
    android_key_restrictions {
      dynamic "allowed_applications" {
        ...
        content {
          # sha256_fingerprint = allowed_applications.value.google_firebase_android_app_sha256_certificate
          sha1_fingerprint = allowed_applications.value.google_firebase_android_app_sha_certificate
