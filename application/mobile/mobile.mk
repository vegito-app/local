...
LOCAL_APPLICATION_MOBILE_APK_BUILDER_IMAGE ?= ${VEGITO_LOCAL_PUBLIC_IMAGES_BASE}:android-flutter-$(VERSION)
LOCAL_APPLICATION_MOBILE_APK_RUNNER_APPIUM_IMAGE ?= ${VEGITO_LOCAL_PUBLIC_IMAGES_BASE}:android-appium-$(VERSION)
...
LOCAL_APPLICATION_MOBILE_ANDROID_RELEASE_AAB_PATH ?= $(LOCAL_APPLICATION_MOBILE_DIR)/build/app/outputs/bundle/release/app-release.aab
LOCAL_APPLICATION_MOBILE_ANDROID_RELEASE_APK_PATH ?= $(LOCAL_APPLICATION_MOBILE_DIR)/build/app/outputs/flutter-apk/app-release.apk
LOCAL_APPLICATION_MOBILE_ANDROID_PACKAGE_NAME ?= $(INFRA_ENV).vegito.app.android
LOCAL_APPLICATION_MOBILE_ANDROID_RELEASE_KEYSTORE_PATH ?= $(LOCAL_APPLICATION_MOBILE_DIR)/$(LOCAL_APPLICATION_MOBILE_ANDROID_PACKAGE_NAME)-release.android.keystore

local-application-mobile-android-release:
	@LOCAL_ANDROID_RELEASE_AAB_UNSIGNED_PATH=$(LOCAL_APPLICATION_MOBILE_ANDROID_RELEASE_AAB_PATH) \
	LOCAL_ANDROID_RELEASE_APK_UNSIGNED_PATH=$(LOCAL_APPLICATION_MOBILE_ANDROID_RELEASE_APK_PATH) \
...
LOCAL_APPLICATION_MOBILE_ANDROID_RELEASE_KEYSTORE_ALIAS_NAME ?= vegito-local-release
...
local-application-mobile-android-release-keystore: 
	@LOCAL_ANDROID_RELEASE_KEYSTORE_ALIAS_NAME=$(LOCAL_APPLICATION_MOBILE_ANDROID_RELEASE_KEYSTORE_ALIAS_NAME) \
