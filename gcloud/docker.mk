...
gcloud-docker-registry-temporary-token:
	...
	@echo  registry: $(GOOGLE_CLOUD_PROJECT_DOCKER_REGISTRY)
...
$(GCLOUD_DOCKER_REPOSITORIES:%=gcloud-%-images-list):
	...
	@$(GCLOUD) container images list --repository=$(GOOGLE_CLOUD_PROJECT_DOCKER_REGISTRY)/$(@:gcloud-%-images-list=%)
...
$(GCLOUD_DOCKER_REPOSITORIES:%=gcloud-%-images-list-tags):
	...
	@$(GCLOUD) container images list-tags $(GOOGLE_CLOUD_PROJECT_DOCKER_REGISTRY)/$(@:gcloud-%-images-list-tags=%)
...
$(GCLOUD_DOCKER_REPOSITORIES:%=gcloud-%-images-delete-all-tags):
	...
	@$(GCLOUD) artifacts docker images list \
      ...
      --format='get(package)' \
      $(GOOGLE_CLOUD_PROJECT_DOCKER_REGISTRY)/$(@:gcloud-%-images-delete-all-tags=%) \
      | uniq \
...
$(GCLOUD_DOCKER_REPOSITORIES:%=gcloud-docker-registry-cleanup-%):
	...
	@PROJECT=$(GOOGLE_CLOUD_PROJECT_ID) \
	  ...
	  REPO=$(GOOGLE_CLOUD_PROJECT_DOCKER_REGISTRY)/$(@:gcloud-docker-registry-cleanup-%=%) \
