export LOCAL_NESTOR_DIR ?= $(CURDIR)

LOCAL_NESTOR_IMAGE_VERSION ?= $(VEGITO_LOCAL_PUBLIC_IMAGES_BASE_NAME):nestor-$(VERSION)
LOCAL_NESTOR_IMAGE_LATEST ?= $(VEGITO_LOCAL_PUBLIC_IMAGES_BASE_NAME):nestor-latest

local-nestor-container-up: local-nestor-container-rm
	@${LOCAL_NESTOR_DIR}/container-up.sh
