...
variable "LOCAL_APPLICATION_TESTS_IMAGE_REGISTRY_CACHE" {
  default = "${VEGITO_LOCAL_PUBLIC_IMAGES_BASE}/cache/application-tests"
}

variable "LOCAL_APPLICATION_TESTS_IMAGE_REGISTRY_CACHE_CI" {
...
target "application-tests-ci" {
  ...
  cache-from = [
    USE_REGISTRY_CACHE ? "type=registry,ref=${LOCAL_APPLICATION_TESTS_IMAGE_REGISTRY_CACHE_CI}" : "",
    "type=inline,ref=${LOCAL_APPLICATION_TESTS_IMAGE_LATEST}",
    LOCAL_APPLICATION_TESTS_IMAGE_DOCKER_BUILDX_LOCAL_CACHE_READ,
  ]
  cache-to = [
    USE_REGISTRY_CACHE ? "type=registry,ref=${LOCAL_APPLICATION_TESTS_IMAGE_REGISTRY_CACHE_CI},mode=max" : "type=inline"
  ]
}
...
target "application-tests" {
  ...
  cache-from = [
    USE_REGISTRY_CACHE ? "type=registry,ref=${LOCAL_APPLICATION_TESTS_IMAGE_REGISTRY_CACHE}" : "",
    LOCAL_APPLICATION_TESTS_IMAGE_DOCKER_BUILDX_LOCAL_CACHE_READ,
    "type=inline,ref=${LOCAL_APPLICATION_TESTS_IMAGE_LATEST}",
  ]
  cache-to = [
    USE_REGISTRY_CACHE ? "type=registry,ref=${LOCAL_APPLICATION_TESTS_IMAGE_REGISTRY_CACHE}" : LOCAL_APPLICATION_TESTS_IMAGE_DOCKER_BUILDX_LOCAL_CACHE_WRITE,
  ]
}
