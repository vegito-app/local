...
#     "linux/amd64") \
#     archive="clarinet-linux-x64-glibc.tar.gz" ; \
#     wget -nv https://github.com/hirosystems/clarinet/releases/download/v${clarinet_version}/$archive && \
#     tar -xf ${archive} && \
#     chmod +x ./clarinet && \
...
USER ${non_root_user}
COPY devnet-entrypoint.sh /usr/local/bin
