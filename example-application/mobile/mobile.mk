...
VEGITO_EXAMPLE_APPLICATION_MOBILE_ANDROID_RELEASE_KEYSTORE_ALIAS_NAME ?= $(LOCAL_ANDROID_RELEASE_KEYSTORE_ALIAS_NAME)
VEGITO_EXAMPLE_APPLICATION_MOBILE_ANDROID_RELEASE_KEYSTORE_PATH ?= $(LOCAL_ANDROID_RELEASE_KEYSTORE_PATH)
VEGITO_EXAMPLE_APPLICATION_MOBILE_ANDROID_RELEASE_KEYSTORE_STORE_PASS_BASE64_PATH ?= $(VEGITO_EXAMPLE_APPLICATION_MOBILE_ANDROID_RELEASE_KEYSTORE_PATH).storepass.base64

VEGITO_EXAMPLE_APPLICATION_MOBILE_APK_BUILDER_IMAGE ?= ${VEGITO_LOCAL_PUBLIC_IMAGES_BASE_NAME}:android-flutter-$(LOCAL_VERSION)
VEGITO_EXAMPLE_APPLICATION_MOBILE_APK_RUNNER_IMAGE ?= ${VEGITO_LOCAL_PUBLIC_IMAGES_BASE_NAME}:android-appium-$(LOCAL_VERSION)

VEGITO_EXAMPLE_APPLICATION_MOBILE_IMAGES_BASE ?= $(VEGITO_EXAMPLE_APPLICATION_PUBLIC_IMAGES_BASE):mobile
VEGITO_EXAMPLE_APPLICATION_MOBILE_IMAGE       ?= $(VEGITO_EXAMPLE_APPLICATION_MOBILE_IMAGES_BASE)-$(VERSION)
...
example-application-mobile-flutter-tests-buildrunner:
	@$(LOCAL_EXAMPLE_APPLICATION_DART) run build_runner test --delete-conflicting-outputs
...
################################################################################
export VEGITO_EXAMPLE_APPLICATION_MOBILE_RELEASE_AAB_PATH ?= $(VEGITO_EXAMPLE_APPLICATION_MOBILE_DIR)/build/app/outputs/bundle/release/app-release.aab
export VEGITO_EXAMPLE_APPLICATION_MOBILE_RELEASE_APK_PATH ?= $(VEGITO_EXAMPLE_APPLICATION_MOBILE_DIR)/build/app/outputs/flutter-apk/app-release.apk
export VEGITO_EXAMPLE_APPLICATION_MOBILE_ANDROID_PACKAGE_NAME ?= $(INFRA_ENV).vegito.app.android
export VEGITO_EXAMPLE_APPLICATION_MOBILE_ANDROID_RELEASE_KEYSTORE_DNAME ?= "CN=Vegito, OU=Dev, O=Vegito, L=Paris, S=IDF, C=FR"
export VEGITO_EXAMPLE_APPLICATION_MOBILE_ANDROID_RELEASE_KEYSTORE_PATH ?= $(LOCAL_ANDROID_RELEASE_KEYSTORE_PATH)
