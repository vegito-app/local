...
export LOCAL_ANDROID_STUDIO_CONTAINER_INSTALL=${LOCAL_ANDROID_STUDIO_CONTAINER_INSTALL:-true}
export LOCAL_ANDROID_STUDIO_ON_START=${LOCAL_ANDROID_STUDIO_ON_START:-true}
export LOCAL_CLARINET_CONTAINER_INSTALL=${LOCAL_CLARINET_CONTAINER_INSTALL:-true}
export LOCAL_CONTAINER_INSTALL=${LOCAL_CONTAINER_INSTALL:-true}
export LOCAL_ROBOTFRAMEWORK_CONTAINER_INSTALL=${LOCAL_ROBOTFRAMEWORK_CONTAINER_INSTALL:-true}
export MAKE_DEV_ON_START=${MAKE_DEV_ON_START:-false}
export LOCAL_VERSION=${LOCAL_VERSION:-v1.22.0}
