...
LOCAL_VSCODE_USER_GLOBAL_STORAGE=${PWD}/.devcontainer/vscode/userData/globalStorage
mkdir -p ${LOCAL_VSCODE_USER_GLOBAL_STORAGE}
# persist locally (gitignored)
ln -sf ${PWD}/.devcontainer/vscode/userData $VSCODE_REMOTE_USER_DATA
# versionned folder for gpt chat logging (folder ${PWD}/.devcontainer/genieai.chatgpt-vscode)
ln -sf ${PWD}/.devcontainer/genieai.chatgpt-vscode ${LOCAL_VSCODE_USER_GLOBAL_STORAGE}/
fi
